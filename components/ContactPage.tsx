...
import { Input } from "@/components/ui/input";
import { Textarea } from "@/components/ui/textarea";
import { Github, Linkedin, Instagram, Mail, Twitter, Sparkles } from "lucide-react";
import emailjs from "@emailjs/browser";
import { toast } from "sonner";

// Initialize EmailJS with public key (run once, ideally in a separate setup file)
...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!serviceId || !templateId || !publicKey) {
      toast.error("Email service configuration is missing. Please try again later.");
