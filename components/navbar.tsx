...
//       <div
//         className={cn(
//           "flex items-center justify-between rounded-full bg-background/10 backdrop-blur-md transition-all duration-300",
//           scrolled
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center px-4 py-4">
      ...
      >
        ...
        <nav className="hidden md:flex items-center gap-8">
          <NavLink href="/" active={getActiveLink("/")}>
            Home
          </NavLink>
          <NavLink href="/about" active={getActiveLink("/about")}>
            About
          </NavLink>
          <NavLink href="/projects" active={getActiveLink("/projects")}>
            Projects
          </NavLink>
          <NavLink href="/contact" active={getActiveLink("/contact")}>
            Contact
          </NavLink>
        </nav>
        ...
        <div className="flex items-center gap-4">
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-full sm:w-80">
              <nav className="flex flex-col gap-6 mt-12">
                <MobileNavLink href="/" active={getActiveLink("/")}>
                  Home
                </MobileNavLink>
                <MobileNavLink href="/about" active={getActiveLink("/about")}>
                  About
                </MobileNavLink>
                <MobileNavLink href="/projects" active={getActiveLink("/projects")}>
                  Projects
                </MobileNavLink>
                <MobileNavLink href="/contact" active={getActiveLink("/contact")}>
                  Contact
                </MobileNavLink>
              </nav>
            </SheetContent>
